...
// Outfled Microphone Mute.cpp : Defines the class behaviors for the application.
//
...
BOOL COutfledMicrophoneMuteApp::InitInstance()
{
	...
	{
		/* Start app hidden */
		if (0 == wcscmp( pCommandLineArgs[1], L"-silent" ))
		{
			dlg.Create( IDD_OUTFLED_MICROPHONE_MUTE_DIALOG );
			dlg.ShowWindow( SW_HIDE );
			nResponse = dlg.RunModalLoop();
		}
	}

	/* No command line args -- show dlg window*/
	else
	{
